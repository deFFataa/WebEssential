    ...
    return (
        <div>
            <Link 
                target="_blank"
                href={href}
                className='flex gap-4 h-full p-3 rounded-lg backdrop-blur-sm shadow-md outline outline-1 outline-white/[25%] hover:scale-[1.02] ease-in duration-100 no-underline hover:no-underline max-sm:w-full'
            >
                <div className="stack items-center p-3">
